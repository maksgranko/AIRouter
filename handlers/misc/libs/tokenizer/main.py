from .model_autodetect import get_model_config, UNKNOWN_MODEL_MULTIPLIER, GLOBAL_MIN_MATCH_THRESHOLD
from .base_calculator import calculate_tokens_with_tiktoken, _get_tiktoken_encoding
...
if __name__ == "__main__":
    # Для запуска требуется: pip install tiktoken python-Levenshtein
    ...
    # ИЗМЕНЕНИЕ ЗДЕСЬ: Используем переменную GLOBAL_MIN_MATCH_THRESHOLD напрямую
