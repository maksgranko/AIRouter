...
- **Эндпоинты**:
  ...
  - и другие, в зависимости от поддержки модулями.
...
8.  **Обновление кэша списка моделей (`/models/refresh`):**
    - **`POST /api/admin/ui/models/refresh`**
      ...
      - **Ответ (JSON)**: `{"status": "success", "message": "Model list cache refreshed."}`
